# Android SDK for GroupDocs.Rewriter Cloud
...
<dependency>
  ...
  <artifactId>GroupDocs-rewriter-cloud-Android</artifactId>
...
```groovy
  ...
  dependencies {
     implementation "com.groupdocs:GroupDocs-rewriter-cloud-Android:25.3"
  }
```
...
* `target/GroupDocs-rewriter-cloud-Android-25.3.jar`
* `target/lib/*.jar`
